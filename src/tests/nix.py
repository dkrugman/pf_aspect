...
class ImportPhotos:
    ...
    def get_playlist_media(self, session, playlist_url, item_path, playlists_to_update, db=None):
        ...
        for playlist_id, playlist_name, subdirectory in playlists_to_update:
            ...
            slides, nix_lastVersion = self.get_single_playlist_media(
                session, playlist_url, item_path, playlist_id, playlist_name, db
            )
...
if __name__ == "__main__":
    ...
    try:
        ...
        media_items, last_version = importer.get_playlist_media(
            session, importer.playlist_url, importer.item_path, playlists_to_update, db
        )
