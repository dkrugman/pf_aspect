...
class GetImageMeta:
    ...
    def __do_image_tags(self, exif):
        tags = {"Image " + str(TAGS.get(key, key)): value for key, value in exif.items()}
    ...
    def __do_iptc_keywords(self):
        ...
        try:
            ...
            self.__logger.warning(
                "IPTC loading has failed - if you want to use this you will need to install iptcinfo3 %s -> %s",  # noqa: E501
                self.__filename,
                e,
            )
